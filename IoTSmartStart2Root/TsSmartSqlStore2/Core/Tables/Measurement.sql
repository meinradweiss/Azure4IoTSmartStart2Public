CREATE TABLE [Core].[Measurement] (
    ...
    CONSTRAINT [PK_Core_Measurement] PRIMARY KEY CLUSTERED ([SignalId] ASC, [Ts] DESC, [Ts_Day] DESC) WITH (DATA_COMPRESSION = PAGE, STATISTICS_INCREMENTAL  = ON) ON [dayPartitionScheme] ([Ts_Day]),
